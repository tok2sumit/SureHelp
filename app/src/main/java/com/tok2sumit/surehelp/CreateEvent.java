...
//    method to delete alarm from sqlite database.
...
//            am.setInexactRepeating(AlarmManager.RTC_WAKEUP, date1.getTime(),24*60*60*1000,pendingIntent);
            am.setInexactRepeating(AlarmManager.RTC_WAKEUP, date1.getTime(),24*60*60*1000,pendingIntent);
...
//   Code to cancel the pending alarm
